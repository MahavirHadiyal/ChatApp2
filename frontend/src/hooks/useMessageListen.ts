...
export function useMessageListen(conversationId: string | undefined, friendId: string | undefined, containerRef: RefObject<HTMLDivElement | null>) {
    ...
    useEffect(() => {
        ...
        const handleNewMessage = (payload: { conversationId: string, message: Message }) => {
            ...
            console.log("full sender object:", payload.message.sender);
