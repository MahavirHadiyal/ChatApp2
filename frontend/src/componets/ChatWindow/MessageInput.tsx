...
const MessageInput:React.FC = ()=>{
    ...
    return <div className="p-4 border border-gray-200 bg-white ">
        ...
        <div className="flex ">
            ...
            <div className="ml-3">
                <button onClick={handleSendMessage} type="button" className="bg-sky-500 text-white rounded-full size-10 flex items-center justify-center hover:bg-sky-600 cursor-pointer my-5">
