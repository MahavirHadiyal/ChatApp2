...
CREATE TABLE "ConversationUnread" (
    ...
    CONSTRAINT "ConversationUnread_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ConversationUnread_conversationId_userId_key" ON "ConversationUnread"("conversationId", "userId");
...
-- AddForeignKey
ALTER TABLE "ConversationUnread" ADD CONSTRAINT "ConversationUnread_conversationId_fkey" FOREIGN KEY ("conversationId") REFERENCES "Conversation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ConversationUnread" ADD CONSTRAINT "ConversationUnread_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
